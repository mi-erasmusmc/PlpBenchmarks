...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (443432,4304008,4297400))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (443432,4304008,4297400))

) I
) C UNION ALL 
SELECT 3 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (439727,374341,4140090,372241,4288013,4043545,375801,4213310))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (439727,374341,4140090,372241,4288013))
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4132546,4133611,4200516))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (4132546,4133611,4200516))

) I
) C UNION ALL 
SELECT 7 as codeset_id, c.concept_id FROM (select distinct I.concept_id FROM
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (4009705,372608,4168666,4104700,4182210,380701,4043378,374009,373179,435088))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
...
LEFT JOIN
(
  select concept_id from @vocabulary_database_schema.CONCEPT where (concept_id in (37116464,36717598,37311999,42535731,376095,377788,372610,4152048))
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  WHERE c.invalid_reason is null
  and (ca.ancestor_concept_id in (37116464,36717598,37311999,42535731,376095,377788,372610,4152048))
...
WHERE (C.start_date >= DATEFROMPARTS(2014, 1, 1) and C.start_date <= DATEFROMPARTS(2014, 12, 31))
AND (YEAR(C.start_date) - P.year_of_birth >= 55 and YEAR(C.start_date) - P.year_of_birth <= 84)
